...
<style lang="scss">
:root {
  --primary: #febe00; // Theme color
  --primaryTwo: #fffaaf;
  --primaryButton: #fffaaf;
  --secondary: #222222; // Button Text
  --third: white;
  --light-text: rgba(0, 0, 0, 0.45);
  --light-text-two: #e2e2e2;
  --accent: #ed1c24;
  --error: #ed1c24;
  --success: #40a05d;
  --background: #fffdf7;
...
.v-date-picker-table > table > tbody > tr > td > .v-btn {
  min-width: 0px;
  min-height: 0px;
  margin-left: 0px;
  margin-right: 0px;
