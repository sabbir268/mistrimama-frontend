              ...
              <v-flex md12 sm12 xs12>
                <v-card class="v-card-padding" flat>
                  <h3 class="custom-title">
                    <v-icon class="custom-icon">local_offer</v-icon>LIST OF AVAILABLE OFFERS
                  </h3>
                  <div v-for="offer in offers" :key="offer" style="margin-top: 15px;">
                    <v-card class="bordered-div border_radius">
...
export default {
  ...
  data() {
    return {
      ...
      offers: [
        {
          title: "500 Taka Bonus on First Recharge",
          description:
            "Get additional 500 Taka at your very first recharge. Terms and conditions applied. l 500 Taka at your very first recharge. Terms and conditions applie l 500 Taka at your very first recharge. Terms and conditions applie l 500 Taka at your very first recharge. Terms and conditions applie"
        },
        {
          title: "Multiple order at 10% discount",
          description: "Get 10 % discount on order more than 2 items at a time."
        }
      ]
    };
  },
