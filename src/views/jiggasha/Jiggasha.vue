        ...
        <v-flex lg12 md12 sm12 xs12>
          <div v-if="dataLoaded" style="text-align: left; margin-bottom: 20px; font-size: 40px">
            <v-layout
              wrap
              align-center
              class="elevation-2 top-gapper side-gapper border_radius"
              style="background-color: white;"
            >
              <v-flex md12 sm12 xs12>
                <v-card class="v-card-padding" flat>
                  <h3 class="custom-title">
                    <v-icon class="custom-icon">question_answer</v-icon>জিজ্ঞাসা
                  </h3>
                  <div v-for="offer in offers" :key="offer" style="margin-top: 15px;">
...
export default {
  data() {
    return {
      ...
      offers: [
        {
          title: "How can I be a verified service provider?",
          description:
            "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. A iaculis at erat pellentesque adipiscing commodo elit at imperdiet. Dignissim enim sit amet venenatis. Nunc sed velit dignissim sodales ut. Et malesuada fames ac turpis egestas maecenas pharetra convallis. Sed elementum tempus egestas sed sed. Amet dictum sit amet justo donec enim diam vulputate ut. Ut lectus arcu bibendum at varius vel pharetra vel turpis. Eget mauris pharetra et ultrices."
        },
        {
          title: "What will be the required documents?",
          description:
            "Arcu cursus euismod quis viverra nibh. Ut aliquam purus sit amet luctus venenatis lectus. Et ligula ullamcorper malesuada proin libero. Scelerisque felis imperdiet proin fermentum leo."
        }
      ]
    };
  },
