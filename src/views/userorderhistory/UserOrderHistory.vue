...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Services", value: "fat" },
        { text: "Charge", value: "carbs" },
        { text: "Extra Charge", value: "protein" },
        { text: "Total Amount", value: "iron", align: "center" },
        { text: "Date", value: "iron", align: "center" },
        { text: "Time", value: "iron", align: "center" },
        { text: "Order Place Time", value: "protein" },
        { text: "Service Provider", value: "iron" },
        { text: "Comrade", value: "carbs" },
  ...
  methods: {
    openDrawer: function(itemObject) {
      this.drawerOrderHistory = true;
      this.sideData = itemObject;
    },
    closeDrawer: function(value) {
      this.drawerOrderHistory = false;
    }
