<template>
  <div class="page-wrapper">
                  ...
                  <ul class="navigation clearfix">
                      ...
                      <ul>
                        <li class="dropdown">
                          ...
                          <ul>
                            ...
                            <li>
                              <a href="about.html">Header Style Seven</a>
                            </li>
                          </ul>
                        </li>
                        <li>
                    ...
                    <li class="dropdown">
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="service-detail.html">Commercial Design</a>
                        </li>
                        <li>
                          <a href="service-detail.html">Landescape Design</a>
                        </li>
                        <li>
                          <a href="service-detail.html">Interior Design</a>
                        </li>
                        <li>
                          <a href="service-detail.html">Complete Interior</a>
                        </li>
                        <li>
                          <a href="service-detail.html">House Interior</a>
                        </li>
                        <li>
                    ...
                    <li class="dropdown">
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="blog-detail.html">Blog Detail 01</a>
                        </li>
                        <li>
                        ...
                        <div class="mega-menu-bar row clearfix">
                          ...
                          <div class="column col-lg-3 col-md-3 col-sm-12">
                            ...
                            <ul>
                              ...
                              <li>
                                <a href="projects.html">Commercial Projects</a>
                              </li>
                              <li>
                                <a href="projects.html">Landescape Projects</a>
                              </li>
                              <li>
                                <a href="project-detail.html">Project Detail</a>
                              </li>
                          ...
                          <div class="column col-lg-3 col-md-3 col-sm-12">
                            ...
                            <ul>
                              ...
                              <li>
                                <a href="blog-detail-2.html">Blog Detail 01</a>
                              </li>
                              <li>
                                <a href="error-page.html">Error Page</a>
                              </li>
    ...
    <section class="banner-section">
      ...
      <!-- <carousel>
          <div class="col-md-12 p-0 m-0">
            <img style="width:100%" src="../assets/images/main-slider/image-1.jpg" alt />
      </div>-->
      <!-- <img style="width:100%" src="../assets/images/main-slider/image-2.jpg" alt />
          <img style="width:100%" src="../assets/images/main-slider/image-3.jpg" alt />
      <img style="width:100%" src="../assets/images/main-slider/image-4.jpg" alt />-->
      <!-- <div
            class="slide-item"
          ...
          <div
            class="slide-item"
            style="background-image: url(../assets/images/main-slider/image-3.jpg);"
          >
           <img src="../assets/images/main-slider/image-3.jpg" alt="">
            <div class="auto-container">
              <div class="content-box">
                <h2>
                  Architecture is a
      ...
      <hooper style="height:auto" :settings="hooperSettings">
        ...
        >
          <div>
            <h1 class="m-auto">Slider Overflow. Check</h1>
          </div>
        </slide>
        <slide
      ...
      <slide>
        <img src="../assets/images/main-slider/image-4.jpg" alt />
        </slide>-->
          ...
          <div class="content-column col-lg-6 col-md-12 col-sm-12">
            <div class="inner-column wow fadeInLeft">
              <div class="content-box">
                ...
                <div
                  class="text"
                >Our company has many years experience and specializes in manufacturing, salling, serviceing and repairing cardan shafts (cardans) for various vehicles, technological equipment, tractor, special machinery and agricultural machinery of verious domestic and foreign manufacturers.</div>
                <div class="link-box">
    ...
    <section class="services-section">
      <div class="upper-box" style="background-image: url(../assets/images/background/2.jpg);">
        <div class="auto-container">
          ...
          <div class="services-carousel owl-carousel owl-theme">
            ...
            <div class="service-block">
              <div class="inner-box">
                ...
                <div class="lower-content">
                  <h3>
                    <a href="service-detail.html">Architectural Design</a>
                  </h3>
                  <div
                    class="text"
                  >Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they.</div>
                  <div class="link-box">
                    <a href="service-detail.html">
                      Lorn More
            ...
            <div class="service-block">
              <div class="inner-box">
                ...
                <div class="lower-content">
                  <h3>
                    <a href="service-detail.html">Corporate Design</a>
                  </h3>
                  <div
                    class="text"
                  >Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they.</div>
          ...
          <div class="team-block col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
              <div class="image-box">
                ...
                <h3 class="name">
                  <a href="team.html">Russel Reed</a>
                </h3>
              </div>
        ...
        <div class="row">
          ...
          <div class="news-block col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
              ...
              <div class="caption-box">
                <h3>
                  <a href="blog-detail.html">In Good Taste: Mark Finlay Architects & Interiors.</a>
                </h3>
                <ul class="info">
                  <li>06 June 2018,</li>
                  <li>John Smith</li>
          ...
          <div class="news-block col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
              ...
              <div class="caption-box">
                <h3>
                  <a href="blog-detail.html">The Lexury Apartment of sepcial interiors.</a>
                </h3>
                <ul class="info">
                  <li>06 June 2018,</li>
                  <li>John Smith</li>
          ...
          <div class="news-block col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box">
              ...
              <div class="caption-box">
                <h3>
                  <a href="blog-detail.html">The Business metting room interior in the rank.</a>
                </h3>
                <ul class="info">
                  <li>06 June 2018,</li>
                  <li>John Smith</li>
    ...
    <!-- Main Footer -->
    <footer class="main-footer" style="background-image: url(../assets/images/background/5.jpg);">
      <div class="auto-container">
        <!--Widgets Section-->
                ...
                <div class="footer-column col-xl-6 col-lg-6 col-md-6 col-sm-12">
                  <div class="footer-widget about-widget">
                    ...
                    <div class="widget-content">
                      <div
                        class="text"
                      >Contra and layouts, in content of dummy text is nonsensical.typefaces of dummy text is appearance of different general the content of dummy text is nonsensical. typefaces of dummy text is nonsensical.</div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="footer-widget recent-posts">
                    ...
                    <div class="widget-content">
                      <div class="post">
                        ...
                        <h4>
                          <a href="blog-detail.html">Triangle Concrete House on lake</a>
                        </h4>
                        <ul class="info">
                          <li>26 Aug</li>
                          <li>3 Comments</li>
                      ...
                      <div class="post">
                        ...
                        <h4>
                          <a href="blog-detail.html">The Amazing Interior for the Hotel art</a>
                        </h4>
                        <ul class="info">
                          <li>26 Aug</li>
                          <li>3 Comments</li>
                    ...
                    <div class="widget-content">
                      <div class="outer clearfix">
                        <figure class="image">
                          ...
                          >
                            <img src="../assets/images/resource/work-thumb-1.jpg" alt />
                          </a>
                        </figure>
                        ...
                        <figure class="image">
                          <a
                            ...
                            title="Image Title Here"
                          >
                            <img src="../assets/images/resource/work-thumb-2.jpg" alt />
                          </a>
                        </figure>
                        ...
                        <figure class="image">
                          <a
                            ...
                            title="Image Title Here"
                          >
                            <img src="../assets/images/resource/work-thumb-3.jpg" alt />
                          </a>
                        </figure>
                        ...
                        <figure class="image">
                          <a
                            ...
                            title="Image Title Here"
                          >
                            <img src="../assets/images/resource/work-thumb-4.jpg" alt />
                          </a>
                        </figure>
                        ...
                        <figure class="image">
                          <a
                            ...
                            title="Image Title Here"
                          >
                            <img src="../assets/images/resource/work-thumb-5.jpg" alt />
                          </a>
                        </figure>
                        ...
                        <figure class="image">
                          <a
                            ...
                            title="Image Title Here"
                          >
                            <img src="../assets/images/resource/work-thumb-6.jpg" alt />
                          </a>
                        </figure>
                      </div>
                    </div>
